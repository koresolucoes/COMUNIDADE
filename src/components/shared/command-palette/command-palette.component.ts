...
export class CommandPaletteComponent implements OnInit {
  ...
  private readonly staticCommands: Command[] = [
    ...
    { name: 'Gerador de Clip-Path', section: 'Ferramentas', action: () => this.navigate('/tools/gerador-clip-path'), icon: 'crop' },
    { name: 'Construtor de Grid CSS', section: 'Ferramentas', action: () => this.navigate('/tools/construtor-grid-css'), icon: 'grid_on' },
    { name: 'Gerador de Filtros CSS', section: 'Ferramentas', action: () => this.navigate('/tools/gerador-filtros-css'), icon: 'filter_b_and_w' },
    { name: 'Gerador de Animação CSS', section: 'Ferramentas', action: () => this.navigate('/tools/gerador-animacao-css'), icon: 'animation' },
